...
function sendNetworkLog(
  ...
  state,
  log_version) {
var formid = "e/1FAIpQLSdljBmHyqUErhmGD33wC-mPIoDYmKDmt3ST1_qjb2fVoT-aIw";
var data = {
  "entry.387524695": uid,
  "entry.95400006": time,
  "entry.1682384009": eventname,
  "entry.58065995": target,
  "entry.1327618872": info,
  "entry.168385545": state,
  "entry.1130359921": log_version
};
var params = [];
for (key in data) {
  params.push(key + "=" + encodeURIComponent(data[key]));
